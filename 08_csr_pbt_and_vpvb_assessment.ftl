<!-- 8. PBT AND vPvB ASSESSMENT template file -->
...
<section>
	...
	<section>
		...
		<#assign recordList = iuclid.getSectionDocumentsForParentKey(substance.documentKey, "FLEXIBLE_RECORD", "PbtAssessment") />	
		...
		<title role="HEAD-3">PBT/vPvB criteria and justification</title>
	...
	<section>
		<title role="HEAD-3">Summary and overall conclusions on PBT or vPvB properties</title>
		
		<#assign summaryList = iuclid.getSectionDocumentsForParentKey(substance.documentKey, "FLEXIBLE_SUMMARY", "PbtAssessment") />	
...
<title role="HEAD-2">Emission characterisation</title>
