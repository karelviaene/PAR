...
<#list csr.testMaterialInformations as testMaterial>
					...
					<tr>
						...
						<td>
							...
							<#if refSubst?has_content>
								...
								<?linebreak?>
								CAS no: <@com.text refSubst.ReferenceSubstanceInfo.CASInfo.CASNumber/>
								<?linebreak?>
								IUPAC name: <@com.text refSubst.ReferenceSubstanceInfo.IupacName/>
							</#if>
						</td>
						<td>
